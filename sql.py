...
#  Author   : Renjith Mangal [ https://t.me/meyitzade47]
#  Licence  : GPL-3
...
def start() -> scoped_session:
    engine = create_engine("postgres://postgres:redsony10@localhost/db_mvc=mysql+pymysql://msb:qwe@localhost/Minitienda?charset=utf8mb4")   
